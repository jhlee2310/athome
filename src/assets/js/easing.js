...
export default new (function ease(){
    const self = this;
    this._def = 'easeOutQuad';
    this.linear = function( x, t, b, c, d ) {
		return t;
    };
    this.swing = function( x, t, b, c, d ){
        return this[def](x, t, b, c, d);
    }
    ...
    this.easeInOutBounce = function (t, b, c, d) {
        ...
        return self.easeOutBounce (t*2-d, 0, c, d) * .5 + c*.5 + b;
    }
})();